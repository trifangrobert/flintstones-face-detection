...
def eval_detections(detections, scores, file_names, ground_truth_path):
    ...
    plt.savefig('bonus_precizie_medie_all_faces.png')
    plt.close()
...
def eval_detections_character(detections, scores, file_names,ground_truth_path,character):
    ...
    plt.savefig('bonus_precizie_medie_' + character + '.png')
    print(character + ' faces: average precision %.3f' % average_precision)
    plt.close()
